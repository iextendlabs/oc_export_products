	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'extension/module/export_products')) {
				$export[] = array(
					'name'	   => $this->language->get('text_export_product'),
					'href'     => $this->url->link('extension/module/export_products/productExport', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($export) {
				$data['menus'][] = array(
					'id'       => 'menu-sale',
					'icon'	   => 'fa-download',
					'name'	   => $this->language->get('text_csv_export'),
					'href'     => '',
					'children' => $export
				);
			}		
